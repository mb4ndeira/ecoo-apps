  ...
  return (
    <div className="mt-10 flex flex-col bg-background text-slate-gray px-8 md:px-10 lg:px-16 pb-10 pt-10 md:pt-16 lg:pt-20">
      ...
      <div className="mt-5 flex gap-x-3">
        <button className="h-11 w-3/5 bg-reject rounded-md font-inter font-semibold text-white ">
          Rejeitar
        </button>
        <button className="h-11 w-3/5 ml-auto bg-rain-forest rounded-md font-inter font-semibold text-white">
          Aprovar
        </button>
      </div>
      <Footer backButton={true} />
