...
export default function Page() {
  return (
    <div className="flex flex-col min-h-[var(--min-page-height)] justify-between items-center pt-20">
      ...
      <div
        className="w-[100vw] max-w-[var(--max-w-md)] min-h-[calc((var(--max-w-md)*235)/360)] relative"
      >
        <Image
          src="/construcao.png"
          alt="Em construção"
          width={360}
          height={235}
          style={{ objectFit: 'contain', objectPosition: 'bottom', position: 'absolute', width: '100%', height: '100%'}}
