    ...
    <div className="w-full h-screen flex flex-col">
      <div className="w-full h-[88%] flex flex-col items-center mt-12">
        ...
        <div className="w-full h-full">
          <form onSubmit={handleSubmit} className="w-full h-full flex flex-col gap-3 mt-4 justify-between">
            <div className="w-full flex flex-col">
              <Input className="text-primary text-sm w-[170px]" type="date" label="Validade" maxLength={8} onChange={handleChange}/>
              {error && <span className="text-red-600 text-sm text-center mt-2">{error}</span>}

              <span className="text[#3E5155] text-sm text-center font-medium mt-5">Está em dúvida? Confira a nossa <br /><span  className="underline">Tabela de Referência</span></span>
            </div>
            <div>
