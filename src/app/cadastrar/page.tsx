  ...
  return (
    <div className="w-full h-screen flex items-center flex-col p-3 pb-6">
      <div className="w-full flex items-center flex-col">
        <h1 className="text-3xl text-slate-gray font-medium mt-28 mb-4">
          Cadastrar
        </h1>
        <span className="text-sm text-slate-gray font-medium mb-12">
      ...
      <div className="flex flex-col w-full space-y-[10px] items-center">
        ...
        <Button
          className="text-white bg-slate-gray"
          title="Cadastrar como produtor"
        />
      </div>
      <div className="mt-6">
        <span className="font-medium text-sm text-slate-gray">
          Esta com alguma dúvida?{" "}
