    ...
    <div>
      ...
      <div className="bg-white w-80 h-40 shrink-0 rounded-2xl">
        ...
        <div className="mt-4 ml-4 mb-4">
          <button className="w-4/12 h-12 py-3 px-4 justify-center items-center shrink-0 rounded-md font-inter bg-ghost-white-100 text-rain-forest font-semibold">
            Sacar
          </button>
          <button className="ml-1.5 w-7/12 h-12 py-3 px-4 justify-center items-center shrink-0 rounded-md font-inter bg-rain-forest text-white font-semibold">
            Concluir venda
          </button>
        </div>
      </div>
